...
public class HandIsWon {
    ...
    @Test
    public void by_player_who_played_ace_when_all_cards_have_same_suit() {
        Hand hand = new Hand(new Suit("Bastoni"), 0);
    ...
    @Test
    public void by_player_who_played_three_when_all_cards_have_same_suit_without_ace() {
        Hand hand = new Hand(new Suit("Bastoni"), 0);
    ...
    @Test
    public void by_player_who_played_highest_value_when_all_cards_have_same_suit_without_ace_or_three() {
        Hand hand = new Hand(new Suit("Bastoni"), 0);
